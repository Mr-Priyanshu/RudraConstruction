  ...
  return (
    <>
      ...
      <div className="flex flex-col sm:flex-col md:flex-row m-2 z-10">
        <div className="relative w-full max-w-[20rem] flex-col border-[25px] border-yellow-500 p-8 text-white md:mx-20 sm:block md:block">
          <div className="h-68 sm:h-72">
          <h1 className="text-4xl sm:text-8xl flex md:w-[30rem] pt-10 sm:pt-24  md:text-4xl text-gray-700 font-serif font-extrabold">
          ...
          <Link to="/Machine-Information">
            <div className="mt-12 p-0">
              <button
                className="block w-full select-none rounded-lg bg-yellow-400 py-3.5 px-7 text-center align-middle font-sans text-sm font-bold uppercase text-white shadow-md shadow-blue-gray-500/10 transition-all hover:scale-[1.02] hover:shadow-lg hover:shadow-blue-gray-500/20 focus:scale-[1.02] focus:opacity-[0.85] focus:shadow-none active:scale-100 active:opacity-[0.85] active:shadow-none disabled:pointer-events-none disabled:opacity-50 disabled:shadow-none"
                type="button"
