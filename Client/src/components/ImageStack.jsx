...
const ImageStack = () => {
  return (
    <>
      <div className="flex justify-center flex-col md:flex-row md:w-full">
        <div className="relative w-[300px] left-10 top-10 md:w-1/3 md:top-28 md:left-28">
        ...
        <div className="relative top-[150px] md:top-28 md:w-1/3 md:flex md:flex-col md:justify-center md:items-center">
          <div className="md:w-[400px] md:ml-20">
            ...
            <h1 className="head text-left ml-6 md:text-2xl md:m-5 ">
              WELCOME TO RUDRA CONSTRUCTIONS SHOWCASE
            </h1>
            <img
