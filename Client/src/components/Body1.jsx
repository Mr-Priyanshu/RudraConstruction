  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <div className="absolute inset-0 flex flex-col justify-center items-start p-4 sm:ms-16 md:pl-40 md:pt-24 overflow-hidden">
        ...
        <h1 className="md:text-[100px]  sm:mt-0 py-0 sm:p-0 leading-tight md:leading-[140px]  w-1345 h-344 left-266 top-558 font-georama font-bold text-7xl tracking-wider text-gray-400"
          style={{ textShadow: 'rgb(0, 2, 0) 1px 5px 5px' }}>
        ...
        <h1 className="md:text-[100px] leading-tight md:leading-[140px]  w-1345 h-344 left-266 top-558 font-georama font-bold text-7xl tracking-wider text-gray-400">
          <AnimatedText>
