...
function Card({ image, category, title, location, description, points }) {
  return (
    <div className="bg-white shadow-lg rounded-lg overflow-hidden max-w-xs md:max-w-sm lg:max-w-sm xl:max-w-sm  p-3 md:p-6">
      ...
      <div className="p-4 mt-3 md:p-6">
        <span className="inline-block bg-gray-50 border  text-gray-600 text-xs px-2 rounded uppercase font-semibold tracking-wide">
          {category}
        </span>
        {/* Card  */}
        <div className="flex flex-wrap t-3  items-center justify-between mt-2">
        ...
        <div className="mt-5 flex flex-row  justify-between space-y-2 md:space-y-0 md:space-x-2 items-center">
