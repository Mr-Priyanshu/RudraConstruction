...
const LiveOngoingProjects = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center pt-28 p-6 bg-white rounded-lg shadow-lg">
      <h2 className="mb-7 sm:mt-7 text-3xl font-bold text-orange-400">Live Ongoing <span className='text-gray-400'>Projects</span></h2>
