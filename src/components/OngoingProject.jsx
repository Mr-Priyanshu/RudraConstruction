...
const OngoingProject = () => {
  const cardData = [
    {
      ...
      points: [
        ...
        "Experience luxury living with our elegantly designed apartment.",
      ],
    },
    {
      image: "/images/cardimg.png",
  ...
  return (
    <div className="flex flex-col items-center justify-center w-full min-h-screen  p-42 mt-15">
      <div className="mb-8 mr-9 flex text-left ">
      ...
      <div className="flex flex-wrap justify-center gap-4 md:gap-8 p-4 mr-11">
