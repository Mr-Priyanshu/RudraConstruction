...
function Card({ image, category, title, location, description, points }) {
  return (
    <div className="bg-white shadow-2xl rounded-lg overflow-hidden max-w-xs md:max-w-sm lg:max-w-sm xl:max-w-sm hover:border border-blue-200 p-3 md:p-6">
      ...
      <div className="p-4 md:p-6">
        ...
        <div className="mt-4 flex flex-col md:flex-row md:justify-between space-y-2 md:space-y-0 md:space-x-2 items-center">
